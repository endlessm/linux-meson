...
#define RT5640_DSP_RATE_NUM (sizeof(rt5640_dsp_rate_tab) / sizeof(rt5640_dsp_rate_tab[0]))
...
int rt56xx_dsp_ioctl_common(struct snd_hwdep *hw, struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case RT_SET_CODEC_DSP_MODE_IOCTL:
		if (*buf <= RT5640_DSP_FFP && *buf >= RT5640_DSP_DIS)
			rt5640->dsp_sw = *buf;
		break;
